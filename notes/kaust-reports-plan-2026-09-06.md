...
| 4 | **BUILT 2026-09-06** as *The maximal value function, drawn* (reports/maxval.html): the instance is ours, the paper has none; u* enclosed as a bracket, not only where Hopf–Lax is exact | Gomes–Ucer arXiv:2606.28378 | viscosity-solution certificate: exact Hopf–Lax over a rational grid, 1-D, separable convex H; DECIDED on {m>0}, CHOSEN on {m=0} | `instruments/hopflax/` | a week |
| 5 | **BUILT 2026-09-06** as *The concentration frontier, as a measurement* (reports/frontier.html): data lifted and pinned, every statement re-derived at build, the kernel not re-run | Gomes–Mitake NoDEA 2015; the congestion CAP and its refusal frontier (sin-mfg mfg-congest) | none new — a measurement over the existing enclosure, layered by N, the N-free ceiling the only solid line | page only | days |
| 6 | **BUILT 2026-09-07** as the playground */instruments/census* (playground/census/): k decided over Q in the tab, Table I repaired within rounding (chosen), sliders along the face | Bakaryan–Aoun–Ribeiro–Hovakimyan–Gomes arXiv:2504.16028; Al Saleh et al. Portugaliae 2024 | none new — facelaw + wardrop-repro + eq-census as one playground | page + playground | days |
| 7 | **BUILT 2026-09-07** as *The clearing price, as a proved band* (reports/price.html): the closed form made Krawczyk unnecessary — the balance is linear and exact; the lab's kernel ported bit for bit and found leaking 12.4 % of the day's energy at its wall | Gomes–Saúde DGA 2021; Ashrafyan–Gomes DGA 2025 (arXiv:2403.02785) | exact price band over a forecast box, attained at the corners; the lab kernel measured (conservation, convergence) | instruments/price (price.js exact, fd.js port) | done |
| 8 | **BUILT 2026-09-07** as *Their tables, re-decided* (reports/agtable.html): the material turned out to be Ashrafyan–Gomes's own two error tables, not our earlier reports' numbers (AFG and AAG print none) — analytic solutions enclosed, scheme rewritten, 13/24 reproduced, tolerance and density findings | Ashrafyan–Gomes arXiv:2403.02785 §8 | intervals around a float scheme against enclosed exact solutions; verdicts per printed cell | instruments/agtable + instruments/interval/taylor2.js | done |
| 9 | **BUILT 2026-09-07** as *The regularization, measured* (reports/regatlas.html): the feared non-analytic nonlinearity is polynomial (γ̄ = 4); a new derivative-weighted ℓ¹ radii polynomial; 34/50 cells proved; ε = 0 certifies as far as any ε; the distance decided | Ferreira–Gomes–Ucer arXiv:2506.21212 | radii polynomial in X_2 for the quasilinear scalar equation after eliminating m; refusal by Z1 as the atlas's void | instruments/regatlas/kernel.js | done |
| 10 | **BUILT 2026-09-07** as *The effective Hamiltonian band* (reports/hbar.html): the classical 1-D formula enclosed (flat exact, rotating to 2e−6, the threshold point undecided), the Mather density where rotating; their Table 1's quoted 4.4099660 found above the enclosure by 7e−7, Table 2's exact value decided | Gomes–Yang ESAIM M2AN 2020 | midpoint-rule enclosures with an interval jet, bisection closed by the mean value theorem; UNDECIDED at the degeneracy | instruments/hbar | done |
