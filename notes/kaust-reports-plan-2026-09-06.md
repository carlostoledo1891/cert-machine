...
| 2 | The monotonicity wall, decided per instance | Ferreira–Gomes–Tada arXiv:2502.20091; Ferreira–Gomes–Voskanyan PAMS 2025 | instance monotonicity (interval Cholesky of the symmetric Jacobian) + no-gradient certificate (Sturm count; port of sin-mfg research/emergent-geometry, 536 lines) over the labs/mfg multiplicity map | port + one module | days |
| 3 | The empty region, painted as refused | Alharbi–Ashrafyan–Gomes AMO 93:40 (2026); Alharbi–Gomes arXiv:2603.01681 | boundary complementarity (exact rational KKT with the auxiliary exit flux h) + vanishing-set certificate (sign enclosure per cell, REFUSED at the free boundary) | interval BVP in 1-D, warrant contour | a week; numbers must be pinned from the AMO full text first |
