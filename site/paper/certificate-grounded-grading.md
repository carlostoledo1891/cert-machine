...
> document was read from `certs/envs-record.json` at build time (2026-09-04, git `2b9ef4e`); the living version of each is at <https://carlostoledo.co/reports/envs.html>, where it is
...
`certs/envs-record.json`; git `2b9ef4e`.*
