...
> document was read from `certs/envs-record.json` at build time (2026-09-05, git `4f2d44c`); the living version of each is at <https://carlostoledo.co/reports/envs.html>, where it is
...
`certs/envs-record.json`; git `4f2d44c`.*
