...
<section class="section">
  <div class="container narrow">
    <div class="prose reveal">
      ...
      <p>That is the argument for reporting three numbers instead of one. A page that printed only the closure ratio would have called them identical. A page that printed only the exact signature would have called them identical too. The reference playground prints the ratio and the triple; the negative mass is what this pass adds, and it is the only thing on the page that could tell the two apart.</p>
