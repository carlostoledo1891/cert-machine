...
<section class="sec"><div class="wrap">
  ...
  <p class="why mt7"><b>That pair is the point.</b> The method does not say everyone is overconfident. It says you can tell which case you are in, and by how much — and the two cases look identical until somebody computes the set. Both reports are competent, both are standard practice, and one of them is carried almost entirely by a choice of curve.</p>
</div></section>

<section class="sec"><div class="wrap">
  <div class="eyebrow">the mathematics, and why there is no optimiser</div>
  <h2 class="mt3">The envelope is closed form</h2>
