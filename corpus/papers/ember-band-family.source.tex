...
% [OWNER: acknowledgments section — collaborators, funding, and the
...
% [OWNER: verify title/venue at deposit time.]

\bibitem{dDPHT} J.~de~Dios~Pont, S.~Hsu, Taylor
[initials to be completed], arXiv:2508.16321 (2025).
% [OWNER: verify author list and title at deposit time — cited here as
...
% [OWNER: verify author list and exact title at deposit time — cited as
