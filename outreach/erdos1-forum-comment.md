...
Status: DRAFT, NOT SENT. Operator-gated like every send. Route ruled 2026-09-15: GitHub first
(the public repository must exist so the link resolves), then this comment. No email to Bloom.
...
2. Replace REPO_URL with the public repository's URL and re-read the four comments on the problem
