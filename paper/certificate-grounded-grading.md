...
> document was read from `certs/envs-record.json` at build time (2026-09-16, git `4ba347a`); the living version of each is at <https://carlostoledo.co/reports/envs.html>, where it is
...
`certs/envs-record.json`; git `4ba347a`.*
