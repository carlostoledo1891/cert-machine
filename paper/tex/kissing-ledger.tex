...
CERTIFIED in 69 milliseconds with 19,704 exact contacts.
...
\begin{remark}
19,704 is also the contact count of configuration~1, and the
coincidence goes further. Normalising every inner product by the shell norm,
the multiset of all 182,106 pairwise inner products of the headline
...
published lists are not the same list: 108 of the $604$ directions
