...
const BATTERIES = [
  ...
  ['breaking (Black Sea waves)', ['instruments/breaking/battery.js'], 'The Black Sea breaking-wave table (16,369 events; Guimarães, Stringari, Leckler, Ardhuin, Zenodo 2026) decided in exact rationals: the literal reader, order statistics as the k-th smallest value, average ranks with ties, Pearson and Spearman as exact r² with r enclosed by integer square roots, and reds that must fire — a NaN, a comma decimal, a reversed line\'s sign, a root\'s lower end, one literal moved by 1e-17 moving an exact r²; then the shipped ledger walked (nine pins re-hashed; the Duncan counts, the self-similarity spreads and the rank correlations re-decided live over the whole table).'],
