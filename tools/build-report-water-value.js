...
B.push(C.section({
  ...
  bodyRaw: C.p('Every source file behind this page was lifted FILE-LEVEL from the research unit\'s public set — '
    ...
    + 'repository listing — and is served byte-preserved under /research/stock-constraint/ beside this rebuilt '
    + 'page: the two original artifacts, the batteries this build re-ran, the reference implementations, and '
...
const foot = '<footer class="col"><p>Generated by tools/build-report-water-value.js @ git ' + git + '. The unit\'s '
  ...
  + 'refuses on any deviation. Source unit files: /research/stock-constraint/ · extracted solver: '
  + 'reports/water_value_tree.extracted.js.</p></footer>';
