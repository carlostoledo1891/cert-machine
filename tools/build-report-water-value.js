...
const foot = '<p>Generated by tools/build-report-water-value.js @ git ' + git + '. The unit\'s '
  ...
  + 'extracted solver: reports/water_value_tree.extracted.js.</p>';
...
fs.writeFileSync(path.join(ROOT, 'reports', 'water-value.html'),
  TPL.render({ title: 'The water value, certified', bodyRaw: B.join('\n\n') + CH.script(), footRaw: foot, path: '/reports/water-value.html',
    desc: 'The shadow price of stored water in a hydro grid is a martingale between stock-binding events — proved by LP duality on scenario trees, at every build.' }));
