...
const foot = '<footer class="col"><p>Generated by tools/build-report-breaking.js @ git ' + git + '. Gates at this build: the ledger re-derived live from the pinned CSV (sha256 ' + L.corpus.csvSha256.slice(0, 12) + '…), the breaking battery (' + nChecks + ' checks, ' + nReds + ' red controls, all fired), every sentence above gated on the ledger field it reads.</p></footer>';
