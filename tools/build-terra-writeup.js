...
/* ---- load and gate every input record ---- */
...
Draft v0.1 (machine-generated) · ${new Date().toISOString().slice(0, 10)} · repository cert-machine @ git ${git}
...
σ = 1/(4π²k); at k = 2,
    ...
    σ* = 1/(8π²) ∈ [${SS.sigmaStar.bracketDecimal[0]}, ${SS.sigmaStar.bracketDecimal[1]}]

(rational bracket via Machin's formula, width ${e2(SS.sigmaStar.widthDecimal)};
