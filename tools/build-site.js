...
const REPORTS = [
  ...
  { g: 'ai', f: 'easota.html', k: 'audit · the SOTA table',
    ...
    desc: 'Together AI’s repository claims a new state of the art over AlphaEvolve on thirteen problems, each checked by the platform’s own float verifier with tolerances. Eighteen published constructions re-decided here in exact arithmetic from their own bytes: fourteen exact witnesses, four witnesses only within tolerance and repaired, every improvement real, one printed digit that is the tolerance’s, and a grid maximum replaced by a certified supremum.',
    n: '18 constructions · 14 witnessed · 4 repaired · 7 of 7 improvements real' },
