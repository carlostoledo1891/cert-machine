...
const REPORTS = [
  ...
  { g: 'applied', f: 'breaking-geometry.html', k: 'ocean engineering · sixteen thousand breakers',
    ...
    desc: 'Guimar\u00e3es, Stringari, Leckler and Ardhuin published the measured geometry of 16,369 breaking waves filmed in stereo on the Black Sea and wrote two sentences: real breakers are not self-similar, and speed does not predict shape. Their per-event table read as the exact numbers it holds and a decided number put under each sentence \u2014 every event against Duncan\u2019s tank band and ratio, the self-similarity ratios as exact order statistics, speed\u2013geometry rank correlations as exact rationals.',
