...
const REPORTS = [
  ...
  { g: 'erdos', f: 'erdos1038-inf.html', k: 'erdős #1038 · the infimum, bracketed',
    ...
    desc: 'Three separate AI-assisted full proofs of Erdős #1038 are claimed on the erdősproblems forum, all reporting the same constant, and the forum itself says nobody associated with it has examined any part of them. This page adjudicates none of them and reports what holds without them: a certified unconditional bracket on the infimum, plus Tao’s model Problem 4.1 answered affirmatively for every ε.',
