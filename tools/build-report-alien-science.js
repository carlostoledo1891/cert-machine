...
const foot = '<p>' + C.esc('Generated by tools/build-report-alien-science.js @ git ' + gitrev
...
fs.writeFileSync(path.join(ROOT, 'reports', 'alien-science.html'),
  TPL.render({ title: 'Alien science needs a disposition · cert-machine', bodyRaw: O.join('\n\n') + CH.script(), footRaw: foot, path: '/reports/alien-science.html',
    desc: 'Scoring AI-generated science: why a certificate — not a score — is what separates a real mathematical discovery from confident noise, with a worked exhibit.' }));
