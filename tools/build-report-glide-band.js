...
const foot = '<p>Generated by tools/build-report-glide-band.js @ git ' + git + '. The app\u2019s '
  ...
  + '\u2026. Instrument: apps/glide-band/kernel.js.</p>';
...
.gb-ctl output{font-family:var(--f-mono);font-size:.78rem;color:var(--ink-2);}
...
.gb-table .mono{font-family:var(--f-mono);color:var(--ink);}
...
fs.writeFileSync(path.join(ROOT, 'reports', 'glide-band.html'),
  TPL.render({ title: 'The ring shows you one answer. There are three.',
    bodyRaw: B.join('\n\n'), cssRaw: STYLE, footRaw: foot, path: '/reports/glide-band.html',
